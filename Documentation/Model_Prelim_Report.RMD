...
size.tab %>%
  kable(caption = "Bluefin tuna size classes",
        booktabs=TRUE,
...
brief <- dat[1:6,]
brief$tourn <- NULL
brief$id <- as.numeric(as.factor(brief$id))
colnames(brief) <- c('Size', 'Trip\nID', 'Year', 'Month', 'Day', 
                    'Hours\nfished', 'Lon', 'Lat', 'nCatch',
                    'SST\n(C)', 'Depth\n(m)', 'Pressure', 'NAO', 'AMO')

# Table
brief %>%
  kable(caption = "American Large Pelagic Survey example",
        booktabs=TRUE) %>%
  kableExtra::kable_styling(
    latex_options = c("HOLD_position")) %>% 
...
# Table
brief %>%
  kable(caption = "Canadian commercial data example",
        booktabs=TRUE) %>%
  kableExtra::kable_styling(
    latex_options = c("HOLD_position")) %>% 
  kableExtra::landscape()
...
![Fig. 5:Small BFT spatio-temporal density](C:/Users/klankowicz/Documents/GitHub/Atlantic-Bluefin-Tuna-Climate-Informed-Stock-Assessment/VAST_runs/tuna8/ln_density--Small-predicted.png)
...
![Fig. 6: Large BFT spatio-temporal density](C:/Users/klankowicz/Documents/GitHub/Atlantic-Bluefin-Tuna-Climate-Informed-Stock-Assessment/VAST_runs/tuna8/ln_density--Large-predicted.png)
...
![Fig. 7: Spatial metrics for small BFT in Canadian EEZ](C:/Users/klankowicz/Documents/GitHub/Atlantic-Bluefin-Tuna-Climate-Informed-Stock-Assessment/Plot_Output/location.info.Small.spring.Canada.png)

![Fig. 8: Spatial metrics for large BFT in Canadian EEZ](C:/Users/klankowicz/Documents/GitHub/Atlantic-Bluefin-Tuna-Climate-Informed-Stock-Assessment/Plot_Output/location.info.Large.spring.Canada.png)
