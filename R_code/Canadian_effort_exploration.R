...
region_shape[region_shape$Region == 'Canada',]
...
meff <- ggplot() +
  ...
  theme(axis.text.x = element_text(angle=35, size=8),
        ...
        legend.title=element_text(size=8),
        legend.background = element_rect(linewidth = 0, fill='transparent')) +
  ggtitle('Spatial effort shift per month')
rm(ms, ml)
...
ggsave(here('CA_effort_illustrations/temporal_effort.png'),
       temef)

ggsave(here('CA_effort_illustrations/spatial_effort.png'),
       oveff)

ggsave(here('CA_effort_illustrations/spatial_yearly_effort.png'),
       yeff)

ggsave(here('CA_effort_illustrations/spatial_monthly_effort.png'),
       meff)

ggsave(here('CA_effort_illustrations/spatial_ym_effort.png'),
